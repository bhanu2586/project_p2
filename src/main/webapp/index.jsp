        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="https://media.istockphoto.com/id/1249219777/photo/shopping-online-concept-parcel-or-paper-cartons-with-a-shopping-cart-logo-in-a-trolley-on-a.jpg?s=612x612&w=0&k=20&c=EWKEahyVLY8iAHyirCCDESHRGW37lqUJ7In0SssNSLE=" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="https://c0.wallpaperflare.com/preview/758/70/513/fashion-mens-fashion-suits-groom.jpg" alt="Dummy" /></li>
                    <li><img class="img-responsive" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIzTf0xJYzU0eCtbCGnjfFvddrbYFR-bHayg&s" alt="Dummy Image" /></li>
                </ul>
                <!-- ><div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="https://media.istockphoto.com/id/864505242/photo/mens-clothing-and-personal-accessories.jpg?s=612x612&w=0&k=20&c=TaJuW3UY9IZMijRrj1IdJRwd6iWzXBlrZyQd1uyBzEY=" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="https://media.istockphoto.com/id/864505242/photo/mens-clothing-and-personal-accessories.jpg?s=612x612&w=0&k=20&c=TaJuW3UY9IZMijRrj1IdJRwd6iWzXBlrZyQd1uyBzEY=" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images.jpg" alt="Dummy Image" />
                            </div></li>
                    </ul>
                    <div class="slide-controller">
                        <a href="#" class="btn-prev"><img src="images.jpg"
                                                          alt="Prev Slide" /></a> <a href="#" class="btn-play"><img
                                src="images.jpg" alt="Start Slide" /></a> <a href="#"
                                                                              class="btn-pause"><img src="images.jpg"
                                               alt="Pause Slide" /></a> <a href="#" class="btn-next"><img
                                src="images.jpg" alt="Next Slide" /></a>
                    </div>
                </div>-->
                <div class="clearfix"></div>
            </div>
