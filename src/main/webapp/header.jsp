...
<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav menu__list">
        ...
        <li class="menu__item"><a class="menu__link" href="submit-complaints.jsp">submit complaint</a></li>
        ...
        <li class="menu__item"><a class="menu__link" href="retailer-login.jsp">Retailer Login</a></li>
