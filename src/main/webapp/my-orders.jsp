                        ...
                        <tr class="rem1">
                            ...
                            <%
                                //If order is delivered
                                 int productId = totalProduct.getInt("id"); 
                                if (totalProduct.getString(15).equals("Deliver")) {
                            %>
                            <td><span class="label label-success"><form action="reviews.jsp" method="post" style="display: inline;">
                             <input type="hidden" name="productId" value="<%= productId %>">
                             
                            
                            <button type="submit"> <strong>delivered Rate this Product</strong></button>
                        </form></span></td>
                            <%
                            } else {
                            %>
