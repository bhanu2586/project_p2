...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "C:\\Users\\yohan\\Downloads\\revature_july_chennai-p0_project_support\\revature_july_chennai-p0_project_support\\onlineshop\\src\\main\\webapp\\uploads";
            ...
            try {
                ...
                try {
                    ...
                    if (i > 0) {
                        ...
                        response.sendRedirect("retailer-add-product.jsp");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
